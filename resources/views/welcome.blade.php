            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2 font-bold">
                        ...
                        <a href="{{ route('register') }}" class="bg-gray-50 p-6 text-gray-700 hover:bg-blue-500 hover:text-gray-50 delay-75 border-l-2">Регистрация</a>
                    </div>
                </div>
                ...
                <div class="text-gray-50">
                    ...
                    <p><a class="text-small hover:underline" href="{{ route('policy.show') }}" target="_blank">Политика конфиденциальности</a></p>
                </div>
